 ...
 * 7번 참가자는 4번이 됩니다. 두 번째 라운드에서 2번은 1번과 붙게 되고, 4번은 3번과 붙게 됩니다.
...
public class 예상대진표 {
    ...
    public static int solution(int n, int a, int b) {
        ...
        // 자기 순번에서 2를 나누었을 때 나머지가 없으면 몫이 그 다음 순번
        // 나머지가 있으면 몫의 + 1 이 그 다음 순번
        // 계속해서 나눠주는 조건은 a b 가 연속되는 숫자가 아닐경우 계속 2로 나누어준다.
        // 아래 코드는 런타임 오류가 남
        /**
         *   while (true) {
         *             answer++;
         *             if (a % 2 == 0) { a = a / 2; } else { a = (a / 2) + 1; };
         *             if (b % 2 == 0) { b = b / 2; } else { b = (b / 2) + 1; };
